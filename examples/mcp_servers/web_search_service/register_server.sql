...
INSERT INTO mcp_servers (name, url, type, enabled, api_key, description, configuration, created_at)
VALUES (
...
INSERT INTO mcp_tools (name, server_id, description, function_json, enabled, created_at)
SELECT 
  'web_search',
  id,
