        ...
        while ((eolIndex = buffer.indexOf('\n\n')) !== -1) {
          ...
          if (line.startsWith("data:")) {
            ...
            try {
              ...
              // Manejar respuestas de MCP
              if (isMcp) {
                console.log('Evento MCP recibido:', event);
                ...
                if (event.text) {
                  ...
                  const resultContent = `Resultado de ${event.toolResult.toolName || 'herramienta'}: ${JSON.stringify(event.toolResult.result || event.toolResult)}`;
              ...
              // Manejar respuestas de OpenAI Assistants
